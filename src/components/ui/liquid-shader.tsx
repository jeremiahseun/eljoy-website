...
export function InteractiveNebulaShader({
    ...
    useEffect(() => {
        ...
        // Cap pixel ratio for performance (shader doesn't need retina)
    ...
    `;
      ...
      void mainImage(out vec4 O, in vec2 fragCoord) {
        ...
        // Ray-march (reduced to 3 iterations for performance)
        for (int i = 0; i <= 3; i++) {
    ...
    return (
        <div
            ref={containerRef}
            className={`absolute inset-0 bg-background ${className}`}
